...
**Hold-period (2-3 cycles AFTER v32 ships; spans BOTH projects)**: cycles count across baby-phi AND i-phi (e.g., i-phi CH-11b + baby-phi CH-NN both count toward the 2-3 cycle threshold). During hold-period, v23 P-plan-3 ALWAYS-FIRE iter-2 re-spawn remains available as fallback; the chunk-archive-plan v4 hard-assertion is the primary defense. If any cycle in the hold-period regresses (iter-1 §1 missing/malformed AND not caught by hard-assertion), revert v32 + investigate. After hold-period (3+ clean cycles), v23 P-plan-3 ALWAYS-FIRE for planner-rec-clean cycles is fully deprecated.
